                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar nav text-center">
                            <li class="nav-item text-white col-12 col-md-2">
                                <a class="nav-link btn" href="http://felicia/" autofocus><img src="/assets/img/Felicia_Logo_W_resize.png" title="going back to home page" class="logoWhite rounded" alt="logo emblème du bateau Felicia"></a>
                            </li>
